...
single JSON line (the shared :func:`~gymrat_py.supervisor.events.to_json_line`
wire form) to a log file. The parent directory is created lazily on the first
write, and a write failure surfaces as a :class:`~gymrat_py.errors.GymratError`
...
from gymrat_py.supervisor.events import SessionEvent, SessionObserver, to_json_line

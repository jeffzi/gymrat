...
conventions in :mod:`gymrat_py.cli.style`; the running sampling and confirm rows
...
from gymrat_py.cli.progress import compact_progress, passes_progress
...
if TYPE_CHECKING:
    ...
    from gymrat_py.cli.progress import _ClockColumn

...
drawn by :mod:`gymrat_py.report.table`, so the columns line up across every
section.
"""
...
if TYPE_CHECKING:
    ...
    from gymrat_py.model import GeomeanResult
    from gymrat_py.report.format import DisplayClass, MetricCellParts
    from gymrat_py.report.table import BodyLine, ValueWidths, VerdictParts, VerdictWidths

...
if TYPE_CHECKING:
    ...
    from gymrat_py.report.table import BodyLine, VerdictWidths
    from gymrat_py.report.types import CandidateComparison, ComparisonResult, MetricComparison

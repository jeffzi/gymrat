...
from gymrat_py.report.format import format_metric_cell_parts
from gymrat_py.report.sections import plan_sections
from gymrat_py.report.style import GROUP_LABEL_STYLE, VARIANT_NAME_STYLE
from gymrat_py.report.table import (
...
if TYPE_CHECKING:
    ...
    from gymrat_py.report.table import BodyLine
